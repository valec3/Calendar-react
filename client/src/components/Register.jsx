...
const Register = () => {
    return (
        <div className="flex h-screen gap-0">
            <div className="bg-slate-800 w-full md:max-w-[700px] h-full flex flex-col items-center justify-center py-6 px-10 text-white">
                <form className='flex md:px-6 justify-center flex-col gap-8 w-full'>
                    <div>
